      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm mt-2 max-w-xl">
              A collection of systems, machine learning applications, and interactive web tools I've engineered.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <article
              key={project.id}
              className="group flex flex-col bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden blue-card-hover shadow-xs"
            >
